...
- I learned how to include backticks (`) around my code, so I can write about it without it becoming a rendered output (useful for viewing my notes later via web browser)
